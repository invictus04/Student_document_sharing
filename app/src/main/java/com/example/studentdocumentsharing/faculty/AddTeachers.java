...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[] {"Select Category" , "Computer Science Department", "IT Department", "Mechanical Department", "Civil Department", "Electrical Department","Electronics Department"};
        ...
        addTeacherImage.setOnClickListener(new View.OnClickListener() { public void onClick(View view) { OpenGallery();} });
